...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React16.useRef(controlledProps);
  if (true) {
    React16.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React30.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
...
var TransitionContext = React33.createContext(null);

// node_modules/@mui/base/useTransition/useTransitionStateManager.js
function useTransitionStateManager() {
  const transitionContext = React34.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React35.useState(true);
  const hasPendingExitTransition = React35.useRef(false);
  const registeredTransitions = React35.useRef(0);
  const [hasTransition, setHasTransition] = React35.useState(false);
  const previousRequestEnter = React35.useRef(requestEnter);
  React35.useEffect(() => {
  ...
  const registerTransition = React35.useCallback(() => {
...
var PopupContext = React36.createContext(null);
...
var Popup = React37.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React37.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
true ? Popup.propTypes = {
   ...
   */
  middleware: import_prop_types13.default.arrayOf(import_prop_types13.default.oneOfType([import_prop_types13.default.oneOf([false]), import_prop_types13.default.shape({
    fn: import_prop_types13.default.func.isRequired,
    name: import_prop_types13.default.string.isRequired,
    options: import_prop_types13.default.any
  })])),
  /**
   ...
   */
  offset: import_prop_types13.default.oneOfType([import_prop_types13.default.func, import_prop_types13.default.number, import_prop_types13.default.shape({
    alignmentAxis: import_prop_types13.default.number,
    crossAxis: import_prop_types13.default.number,
    mainAxis: import_prop_types13.default.number
  })]),
  /**
...
var Menu = React38.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React39.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React40.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
var InnerMenuItem = React43.memo(React43.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled: disabledProp = false,
...
var MenuItem2 = React43.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
true ? MenuItem2.propTypes = {
   ...
   * @default false
   */
  disableFocusOnHover: import_prop_types16.default.bool,
  /**
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime30.jsx)(React53.Fragment, {
...
var Select = React53.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React53.Fragment, {
    ...
    })), buttonDefined && (0, import_jsx_runtime30.jsx)(Popup, _extends({
      slots: {
        root: PopupComponent
      }
    }, popupProps, {
...
true ? Select.propTypes = {
  ...
  slotProps: import_prop_types21.default.shape({
    ...
    popup: import_prop_types21.default.oneOfType([import_prop_types21.default.func, import_prop_types21.default.object]),
  ...
  slots: import_prop_types21.default.shape({
    ...
    popup: import_prop_types21.default.elementType,
...
var Slider = React54.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime33.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime32.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime32.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime33.jsxs)(React54.Fragment, {
...
true ? Slider.propTypes = {
   ...
   * @default 10
   */
  shiftStep: import_prop_types22.default.number,
  /**
...
true ? CssAnimation.propTypes = {
  ...
  enterAnimationName: import_prop_types30.default.string,
  enterClassName: import_prop_types30.default.string,
  exitAnimationName: import_prop_types30.default.string,
...
true ? CssTransition.propTypes = {
  ...
  lastTransitionedPropertyOnEnter: import_prop_types31.default.string,
  lastTransitionedPropertyOnExit: import_prop_types31.default.string
} : void 0;
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HXMBBH6C.js.map
